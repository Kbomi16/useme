    ...
    <section id="landing-problem" className="scroll-mt-20 py-16 sm:py-24">
      <StaggerReveal className="mx-auto flex w-full max-w-5xl flex-col items-center gap-12 px-6">
        <div className="flex max-w-2xl flex-col items-center gap-3 text-center">
          <h2
            data-stagger
            className="text-[28px]/snug font-bold tracking-tight break-keep text-muted-foreground sm:text-[34px]/snug"
          >
            링크만 보내는 공유는 그만
          </h2>
          <p
        ...
        <div className="grid w-full gap-10 md:grid-cols-2">
          ...
          >
            <div className="flex aspect-4/3 w-full max-w-sm items-center justify-center overflow-hidden rounded-[28px] bg-muted">
              <Image
            ...
            <figcaption className="flex flex-col gap-1">
              ...
              <p className="text-base font-bold tracking-tight break-keep">
                한 줄 떨어지고 끝나요
              </p>
              <p className="text-sm/relaxed break-keep">
...
function AppealCardDevice({ project }: { project: SampleProject }) {
  ...
  return (
    <div className="relative flex aspect-4/3 w-full max-w-sm items-center justify-center overflow-hidden rounded-[28px] bg-muted">
      <div
        aria-hidden="true"
        className="absolute -top-8 -right-10 size-44 rounded-full bg-primary/12"
      />
      <div className="relative w-[76%] rotate-[-5deg]">
        <div className="rounded-[30px] bg-foreground/90 p-1.5 shadow-[0_22px_44px_rgb(42_36_56/0.28)]">
          ...
          <article className="overflow-hidden rounded-[24px] bg-card">
            ...
            <div className="flex flex-col gap-2 p-3">
              ...
              <ul className="flex flex-col gap-1">
                {rows.map((row) => (
                  <li key={row.hint} className="flex items-center gap-1.5">
                    <span className="inline-flex shrink-0 rounded-full bg-secondary px-1.5 py-0.5 text-[10px] font-semibold text-secondary-foreground">
                      {row.hint}
                    </span>
                    <p className="min-w-0 truncate text-left text-xs/snug">
                      {row.text}
                    </p>
                  </li>
                ))}
              ...
              <div
                aria-hidden="true"
                className="flex h-8 items-center justify-center rounded-lg bg-primary text-xs font-semibold text-primary-foreground"
              >
                써 보기
              </div>
            </div>
